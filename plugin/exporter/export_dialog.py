...
class ExportDialog:
    ...
    def __init__(self, adapter, callback):
        ...
        self._dialog = gtk.Dialog("Možnosti exportovania", None, 0, None)
        self._dialog.connect("delete-event", lambda *_: self._dialog.destroy())
        self._dialog.set_size_request(300, 400)
        self._dialog.set_border_width(10)

        self._radio1 = gtk.RadioButton(None, "exportovať celý projekt")
        self._radio2 = gtk.RadioButton(self._radio1, "exportovať zvolený priečinok")
        ...
        self._label = gtk.Label("Priečinok ktorý sa bude exportovať")
        ...
        self._ok_button = gtk.Button("Exportovať")
